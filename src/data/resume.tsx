...
export const DATA = {
  ...
  technicalExperience: [
    {
      ...
      bullets: [
        ...
        "Design & build social media content generation workflow: monitors live news & social feeds for client-industry signals → LLM scores and ranks signals by relevance → generates post copy for the top signal → programmatically composites title and body onto a nano-banana-generated image (deterministic text placement, no AI-generated text) → exports the final post to the client's Notion page via Notion MCP",
    ...
    },
    {
      ...
      bullets: [
        {
          text: "Led & built smart contracts on mainnet for:",
          sub: [
            "MEME Public Sale which locked over $50M in ETH",
            "MEME Launch & Vesting which locked over $120M in $MEME",
            "Stakeland which secured over $60M in TVL",
          ],
        },
        {
          text: "Single-handedly design & build the smart contracts for:",
          sub: [
            "Liquid Staking Protocol like Lido but more efficient",
            "Bonding Curve Token Launch Protocol like pump.fun but for EVM",
            "Crosschain $MEME via Wormhole",
            "Stakeland v2 via Uniswap Permit2",
            "SPL Token Presale contract on Solana with Rust and Anchor",
          ],
        },
    ...
    },
    {
      ...
      bullets: [
        {
          text: "Develop smart contracts on ETH & Polkadot for:",
          sub: [
            "DEX similar to Balancer + native liquid staking of $DOT on parachain of Polkadot (securing >1M USD in TVL)",
            "NFT Projects (with ERC2981 Royalty Standard)",
            "Cross-chain NFTFi (w/ Axelar bridge messaging)",
          ],
        },
    ...
    },
    {
      ...
      bullets: [
        "Lead on system design, task allocation and project management while supervising whole tech team",
    ...
    },
    {
      ...
      location: "Hong Kong",
      title: "Web Developer",
      logoUrl: "/logo_soul.jpg",
      start: "Jun 2020",
      end: "Jun 2021",
      bullets: [
        "Develop modern and reliable NFT-related frontend applications, and gas-efficient smart contracts on Ethereum via TypeScript, Solidity, Truffle/Hardhat, Web3.js/Ethers.js and Waffle",
        "Revamp and optimize SOUL's whole Shopify website by writing well-designed, testable and reusable code",
      ],
    },
    {
      company: "Infin Media",
      ...
      bullets: [
        "Full-stack web application development — lead architectural decisions, testing, code review & deployment",
        "Build RESTful API services and relational databases on LAMP stack",
      ],
    },
  ],
  education: [
  ...
  projects: [
    ...
    },
    {
      ...
      active: true,
      description:
        "Agentic social media content pipeline built on OpenClaw + Hermes: monitors live news and social feeds for client-industry signals → LLM scores and ranks each signal by relevance → generates post copy for the winner → programmatically composites title and body text onto a nano-banana-generated image (deterministic text placement instead of unreliable AI-generated text) → exports the final post — image and copywriting — to the client's Notion page via Notion MCP.",
      technologies: [
        "OpenClaw",
        "Hermes",
        "LLM",
